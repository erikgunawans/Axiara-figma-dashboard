...
import { Layers, PlusCircle, Bot, ArrowLeft, Search, ChevronsLeft, ChevronsRight, LogOut } from "lucide-react";
        ...
        {navItems.map((item, i) => {
          ...
          return (
            <button
              ...
              onClick={() => { setActiveIndex(i); navigate(navRoutes[i]); }}
      ...
      {!sidebarCollapsed && (
        <div style={{ margin: "0 8px 10px" }}>
          <button
            ...
            onMouseEnter={(e) => {
              e.currentTarget.style.borderColor = "rgba(241,79,68,0.15)";
